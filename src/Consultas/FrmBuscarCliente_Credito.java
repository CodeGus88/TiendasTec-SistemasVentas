...
//import Presentacion.FrmNewClient;
 ...
 * @author DAYPER-PERU
 */
public class FrmBuscarCliente_Credito extends javax.swing.JInternalFrame {

    static ResultSet rs=null;
    DefaultTableModel dtm=new DefaultTableModel();

    String criterio,busqueda,Total;
    public FrmBuscarCliente_Credito() {
        initComponents();
...
//-----------------------------------------------------------------------------------------------
   ...
   //--------------------PRESENTACION DE JTABLE----------------------
    ...
    private void initComponents() {
        ...
        txtBusqueda.setBounds(30, 61, 380, 22);
        ...
        rbtnDni.setBounds(350, 31, 34, 20);

        rbtnRuc.setText("NIT");
        getContentPane().add(rbtnRuc);
        rbtnRuc.setBounds(280, 31, 41, 20);
        ...
        rbtnNombre.setBounds(120, 31, 150, 20);
        ...
        rbtnCodigo.setBounds(30, 31, 90, 20);
    ...
    private void tblClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClienteMouseClicked
        ...
        if (fila == -1){
            ...
            Presentacion.FrmCredito.lblIdCliente.setText((String) defaultTableModel.getValueAt(fila, 0));
            Presentacion.FrmCredito.txtNombreCliente.setText((String) defaultTableModel.getValueAt(fila, 1));
