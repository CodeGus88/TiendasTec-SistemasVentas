 ...
 * @author DAYPER-PERU
 */
public class FrmBuscarProducto_Credito extends javax.swing.JInternalFrame {
    ...
    public FrmBuscarProducto_Credito() {
    ...
    private void tblProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductoMouseClicked
        ...
        if (fila == -1){
            ...
            defaultTableModel = (DefaultTableModel)tblProducto.getModel();
                ...
                Presentacion.FrmCredito.lblIdProducto.setText((String)defaultTableModel.getValueAt(fila,0));
                Presentacion.FrmCredito.txtCodigoProducto.setText((String)defaultTableModel.getValueAt(fila,1));
                Presentacion.FrmCredito.txtNombreProducto.setText((String)defaultTableModel.getValueAt(fila,2));
                Presentacion.FrmCredito.txtDescripcionProducto.setText((String)defaultTableModel.getValueAt(fila,3));
                Presentacion.FrmCredito.txtStockProducto.setText((String)defaultTableModel.getValueAt(fila,4));
                Presentacion.FrmCredito.txtCostoProducto.setText((String)defaultTableModel.getValueAt(fila,5));          
                Presentacion.FrmCredito.txtPrecioProducto.setText((String)defaultTableModel.getValueAt(fila,6));          
